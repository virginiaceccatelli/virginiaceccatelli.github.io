...
const projects = [
  ...
  { num: "04", title: "Agentic Purple-Teaming Loop", blurb: "Automated red-teaming and hardening loop for AI agents, with an attacker taxonomy spanning prompt injection, tool-parameter manipulation, and goal hijacking, plus an evaluation harness for detection and bypass rates.", tags: ["AI Security", "Red-Teaming", "Agents"], repo: null, link: null, linkLabel: null, status: "Ongoing — WIIT" },
