...
const projects = [
  { num: "01", title: "Agentic Purple-Teaming Loop", blurb: "Automated red-teaming and hardening loop for AI agents", tags: ["AI Security", "Red-Teaming", "Agents"], repo: null, link: null, linkLabel: null, status: "Ongoing — WIIT" },
  { num: "02", title: "LLM Uncertainty Quantification Taxonomy", blurb: "Using probes to capture uncertainty signals across four lenses: structural (full attention + write norms), representational (mid-layer hidden state), distributional (token-level output distribution) and semantic (meaning-level uncertainty).", tags: ["Interpretability", "Uncertainty", "LLMs"], repo: null, link: null, linkLabel: null, status: "Ongoing — UCL S2Lab" },
  { num: "03", title: "LLM Uncertainty Signals & Code-Model Semantics", blurb: "Framework tracing binding, data flow, control dependence, and security taint flow in code models by probing whether they encode latent code property graphs, and how these encodings change across context length and obfuscations.", tags: ["Interpretability", "Program Analysis", "Semantic Representation"], repo: null, link: null, linkLabel: null, status: "Ongoing — UCL S2Lab" },
  { num: "04", title: "SpeechJBB: Code-Switched Speech Safety Evaluation", blurb: "First audio-based code-switching jailbreak benchmark for multilingual speech-safety evaluation, exposing weaknesses in SOTA large audio language model safety alignment.", tags: ["AI Safety", "LALMs", "Speech", "Code-Switching"], repo: null, link: "https://arxiv.org/abs/2606.06037", linkLabel: "View paper", status: "EMNLP 2026" },
  { num: "05", title: "VoxSumm: Multilingual Corpus for Summarization and Translation", blurb: "Multilingual corpus for joint summarization and translation of long-form spoken news in low-resource languages, developed in collaboration with Google DeepMind.", tags: ["Dataset", "Speech", "Summarization", "Translation"], repo: null, link: "https://huggingface.co/datasets/McGill-NLP/speech-translation-and-summarization", linkLabel: "View dataset", status: "Submitted — EACL 2027" },
  { num: "06", title: "RL Data Preprocessing Automation", blurb: "Reinforcement-learning-driven data quality pipeline: outlier detection, imputation, and financial validity rules to reduce manual preprocessing.", tags: ["Reinforcement Learning", "Pandas", "Sklearn", "Finance"], repo: null, link: null, linkLabel: null, status: "Wavestone · 2024" },
  { num: "07", title: "Robotic Ground Segmentation & Motion Decision", blurb: "Real-time RGB-only ground segmentation using U-Net + MobileNetV2 backbone and CNN-based directional decision for autonomous indoor robot navigation, reaching 0.91 validation IoU.", tags: ["PyTorch", "TorchScript", "OpenCV", "Robotics"], repo: "https://github.com/virginiaceccatelli/vision_control", link: null, linkLabel: "View code", status: "McGill Prometheus Lab · 2025" },
  { num: "08", title: "Cisco SOHO Network Simulation", blurb: "Small Office / Home Office network design and configuration on Cisco Packet Tracer, covering subnetting, VLANs, and routing protocols.", tags: ["Cisco", "Subnetting", "Routing", "Networking"], repo: "https://github.com/virginiaceccatelli/Cisco-Packet-Tracer-Projects", link: null, linkLabel: "View code", status: "2024" },
];
